    ...
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-8 py-10">
      <div className="mb-6">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-semibold text-slate-700 bg-slate-100 border border-slate-200 mb-3">
          ...
          <span><CourseText pageId="fisica--bitacora" fieldId="text-1">Física • Instrumento de Registro</CourseText></span>
        </div>
        <h1 className="text-3xl sm:text-4xl font-bold text-[#1C1C1C] font-['Quicksand'] tracking-tight"><CourseText pageId="fisica--bitacora" fieldId="text-2">
      ...
      <div className="bg-white border-2 border-slate-800 rounded-xl p-6 sm:p-7 mb-8 shadow-xs">
        <div className="flex items-start gap-3">
          ...
          <div className="space-y-3 text-xs sm:text-sm text-[#1C1C1C] leading-relaxed">
            <p className="font-medium"><CourseText pageId="fisica--bitacora" fieldId="text-3">
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-md p-3 text-xs text-slate-800">
              <strong className="block font-semibold uppercase tracking-wider mb-1"><CourseText pageId="fisica--bitacora" fieldId="text-4">
                Requisito:
              </CourseText></strong><CourseText pageId="fisica--bitacora" fieldId="text-5">
              Presentar la bitácora impresa para cada una de las prácticas.
            </CourseText></div>
            <p className="text-xs text-[#4A4A4A]"><CourseText pageId="fisica--bitacora" fieldId="text-6">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h2 className="text-base font-bold text-[#1C1C1C] font-['Quicksand']"><CourseText pageId="fisica--bitacora" fieldId="text-7">
            Formatos y Organizadores de Práctica (</CourseText><CourseDocumentCount subjectId="fisica" category="bitacora" /><CourseText pageId="fisica--bitacora" fieldId="text-8"> Archivos)
          </CourseText></h2>
          <span className="text-xs text-slate-500 font-mono"><CourseText pageId="fisica--bitacora" fieldId="text-9">Descargas Autorizadas</CourseText></span>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          <CourseDocuments subjectId="fisica" category="bitacora" />
        </div>
      </div>
    </div>
  );
