    ...
    >
      <svg className="stroke-text__svg" viewBox={viewBox} preserveAspectRatio="xMidYMid meet" aria-hidden="true">
        ...
        <text
          ...
          y="0"
          fill="none"
          stroke={strokeColors ? undefined : strokeColor}
        ...
        >
          {characters.map((char, index) => (
            <tspan
              data-stroke-char
              key={`s-${index}`}
              stroke={strokeColors ? strokeColors[index % strokeColors.length] : undefined}
            >
              {char}
            </tspan>
          ))}
        ...
        <text
          ...
          x="0"
          y="0"
          fill={fillColors ? undefined : fillColor}
          stroke="none"
          style={fontStyle}
        ...
        >
          {characters.map((char, index) => (
            <tspan
              data-fill-char
              key={`f-${index}`}
              fill={fillColors ? fillColors[index % fillColors.length] : undefined}
            >
              {char}
            </tspan>
          ))}
